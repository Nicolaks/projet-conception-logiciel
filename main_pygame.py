...
def Jeux(Hht, Wth):
    ...
    Wave_played = Wvs.Waves(_dict_Patern, __GroupBullet_enn, __GroupSHIP)#On initialise notre objet de Vague
    ...
    #Spaceship.bullet_type = ""#Ligne non nécéssaire
